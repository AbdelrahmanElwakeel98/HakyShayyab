...
public class CarpetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = findViewById(R.id.carpet_list);
        ...
        if (Global.userType.equals("Bedouin")){
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    startActivity(new Intent(CarpetActivity.this, AddActivity.class));
                    finish();
                }
            });
        }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            manualAdapter = new ManualAdapter(CarpetActivity.this, manuals);
                            list.setLayoutManager(new LinearLayoutManager(CarpetActivity.this));
                            list.setAdapter(manualAdapter);
